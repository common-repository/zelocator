...
class HC3_Hooks implements HC3_Wordpress_IHooks
{
	...
	public function __construct( HC3_Dic $dic, $pluginName, $pluginPrefix, HC3_Profiler $profiler = NULL )
	{
		$this->dic = $dic;
	...
	{
		$return = new HC3_HooksWrapper( $obj, $this, $this->profiler );
		return $return;
	}
